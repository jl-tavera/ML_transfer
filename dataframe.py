...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Nacional')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Nacional')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Nacional_GK')
