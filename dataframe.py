...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Pasto')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Pasto')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Pasto_GK')
