...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Envigado')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Envigado')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Envigado_GK')
