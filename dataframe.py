...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Once Caldas')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'OnceCaldas')
FBref.exportFinalCSV(signings_stats[1],'/teams/','OnceCaldas_GK')
