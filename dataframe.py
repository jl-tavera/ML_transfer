...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Millonarios')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Millonarios')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Millonarios_GK')
