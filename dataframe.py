...
signings_stats = FBref.getAllSquadSigningStats(signings, 'AD Cali')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'ADCali')
FBref.exportFinalCSV(signings_stats[1],'/teams/','AD Cali_GK')
