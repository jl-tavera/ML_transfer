...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Tolima')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Tolima')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Tolima_GK')
