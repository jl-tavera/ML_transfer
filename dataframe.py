...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Junior')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Junior')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Junior_GK')
