...
signings_stats = FBref.getAllSquadSigningStats(signings, 'Rionegro')
FBref.exportFinalCSV(signings_stats[0],'/teams/', 'Rionegro')
FBref.exportFinalCSV(signings_stats[1],'/teams/','Rionegro_GK')
